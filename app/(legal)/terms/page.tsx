...
export default function TermsAndConditions() {
    return (
        <div className="min-h-screen bg-white" data-oid="583twqf">
            <div className="max-w-4xl mx-auto px-6 py-16" data-oid=":gx71tg">
                <h1 className="text-4xl font-bold mb-8" data-oid="uedgrsm">
                    Terms and Conditions
                </h1>

                <div className="prose prose-lg max-w-none" data-oid="ulon1ec">
                    <p className="text-xl mb-8" data-oid="d3i9.hv">
                        We take user privacy very seriously & hence put every effort to keep things
                        safe & secure for you!
                    </p>

                    <h2 className="text-2xl font-semibold mt-8 mb-4" data-oid="aybkwwa">
                        Terms of Service
                    </h2>
                    <p data-oid="5.ok-aw">
                    ...
                    <h2 className="text-2xl font-semibold mt-8 mb-4" data-oid="96nwv:4">
                        Definitions
                    </h2>
                    <p data-oid="1t-6:km">
                    ...
                    <ul className="list-disc pl-6 mb-4" data-oid="lak3txm">
                        <li data-oid="vqnn73-">
                    ...
                    <h2 className="text-2xl font-semibold mt-8 mb-4" data-oid="37g-4y_">
                        Access and Use
                    </h2>
                    <p data-oid=".zfo-_l">
                    ...
                    <h2 className="text-2xl font-semibold mt-8 mb-4" data-oid="ieaygfq">
                        Unacceptable Use
                    </h2>
                    <p data-oid="_l2h7ll">
                        Customer and Users shall not, nor attempt to, nor permit third parties to:
                    </p>
                    <ul className="list-disc pl-6 mb-4" data-oid="ecgwykh">
                        <li data-oid="xiza50n">
                        ...
                        <li data-oid="1rl3wov">Send any viruses, worms, or other harmful code</li>
                        <li data-oid="vwixr..">
                    ...
                    <h2 className="text-2xl font-semibold mt-8 mb-4" data-oid="k74dw-4">
                    ...
                    <h2 className="text-2xl font-semibold mt-8 mb-4" data-oid="3ue4:tm">
                        Data and Privacy
                    </h2>
                    <p data-oid="ivzc0xw">
                    ...
                    <h2 className="text-2xl font-semibold mt-8 mb-4" data-oid="d:o4r8_">
                    ...
                    <ul className="list-disc pl-6 mb-4" data-oid="qf_e8:h">
                        <li data-oid="noaluvu">
                    ...
                    <h2 className="text-2xl font-semibold mt-8 mb-4" data-oid="yv1i_1k">
                    ...
                    <h2 className="text-2xl font-semibold mt-8 mb-4" data-oid="xvttbk4">
                        Contact Us
                    </h2>
                    <p data-oid="bbksukp">
                    ...
                    <div className="mt-8 pt-8 border-t" data-oid="5kplvmp">
                        <p className="text-sm text-gray-600" data-oid="v56xsx4">
